...
class pageAddEdit_Fdmaster extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id: 0,
    ...
    this.obj = this;
    this.formTitle = "FD Master";
    this.breadCrumbTitle = "FD Master";
    this.breadCrumbItem = "Add " + this.formTitle;
    this.API_URL_SAVE = "AddFdMaster/0/token";
    this.pushFormName = "/Fdreport";
    this.rtPage_Redirect = "/Fdreport";
  ...
  btnSave_onClick(event, formData) {
    ...
    vformData.append("Amount", formData.FdAmount);
  ...
  calculateEMIAndRepaymentAmount = (FdAmount, tenure, periodicity, rateOfInterest) => {
    let periodicRate;
    ...
    const numerator = FdAmount * periodicRate * Math.pow(1 + periodicRate, numberOfPayments);
  ...
  handleCalculate = async (FdAmount) => {
    ...
    try {
      let vformData = new FormData();
      vformData.append("FdAmount", FdAmount);
                            ...
                            <Col lg="12">
                              <Card>
                                <CardBody>
                                  ...
                                  <Row>
                                    <Col sm="2" className="mb-3">
                                      <label htmlFor="middleName" className="col-form-label">Fd Amount</label>
                                    </Col>
                                    <Col sm="3">
                                      <AvField name="FdAmount" label="" value={this.state.FdAmount === null ? '' : this.state.FdAmount} onChange={(e) => this.handleCalculate(e.target.value)} placeholder="Enter FdAmount" errorMessage="Enter " validate={{ required: { value: true } }} type="numeric" className="form-control" />
                                    </Col>
...
export default compose(container)(pageAddEdit_Fdmaster);
