...
class BusesList extends Component {
  ...
  render() {
    ...
    const { buses, showSeats, seatData, selectedSeats, selectedBusId, showBoardDropModal, selectedBoardingId, selectedDroppingId, busdata, isMobile, showFilters, copyNotification } = this.state;
    return (
