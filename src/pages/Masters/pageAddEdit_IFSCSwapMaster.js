...
class pageAddEdit_IFSCSwapMaster extends Component {
  constructor(props) {
    super(props);
    this.state = {
      id: 0,
    ...
    this.obj = this;
    this.formTitle = " BANK API SWITCH IFSC";
    this.breadCrumbTitle = "Masters";
    this.breadCrumbItem = "Add " + this.formTitle;
    this.API_URL = API_WEB_URLS.MASTER + "/0/token/IFScSwap";
    this.API_URL_SAVE =  "IFSCSwap/0/token";
    this.pushFormName = "/ifscswap";
...
export default compose(container)(pageAddEdit_IFSCSwapMaster);
